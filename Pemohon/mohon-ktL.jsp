...
<%
    if (request.getParameter("kemaskini") != null) {
        ...
        ResultSet rs;
        pst = con.prepareStatement("update pemohon set ktL = ? where noKp = ? ");        
        pst.setString(1,ktL);
...
<html>
    ...
    <body>
        ...
        <div class="navbar">
                ...
                <nav>
                    <ul class="items">
                        <li><a href="mohon-index.html">Kembali</a></li>
                    </ul>
                </nav>
            </div>
        <form>
            ...
            <table class="table" align="center">
                <%
                    ...
                    try {
                        ResultSet rs;
                        String noKp = request.getParameter("noKp");
                        rs = st.executeQuery("select * from pemohon where noKp = '" + noKp + "'   ");
                        while (rs.next()) {
                %>
